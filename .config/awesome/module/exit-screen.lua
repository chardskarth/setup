...
local clickable_container = _G.my_theme.clickable_container
local icons = _G.my_theme.icons
...
exit_screen.bg = beautiful.bg_normal .. 'dd' --beautiful.background.hue_800 .. 'dd'
